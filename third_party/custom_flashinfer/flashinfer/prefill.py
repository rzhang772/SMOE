...
class BatchPrefillWithPagedKVCacheWrapper:
    ...
    def plan(
        ...
        self._plan_info = self._cached_module.plan(
            ...
            num_kv_heads,
            page_size,
            self._plan_info[0] if self._plan_info is not None and self._use_cuda_graph else 0,
            self._plan_info[3] if self._plan_info is not None and self._use_cuda_graph else 0,
